...
class ZoomAnimatedTransitioningDelegate: NSObject, UIViewControllerTransitioningDelegate {
    ...
    open weak var referenceSlideshowView: SlideshowGallery?
    ...
    public init(slideshowView: SlideshowGallery, slideshowController: FullScreenSlideshowViewController) {
    ...
    @objc func handleSwipe(_ gesture: UIPanGestureRecognizer) {
        ...
        if gesture.state == .began {
            ...
            let velocity = gesture.velocity(in: refView)

            if abs(velocity.y) > 500 {
                referenceSlideshowController.pageSelected?(referenceSlideshowController.slideshow.currentPage)
...
class ZoomAnimator: NSObject {
    ...
    var referenceSlideshowView: SlideshowGallery?
    var parent: ZoomAnimatedTransitioningDelegate

    init(referenceSlideshowView: SlideshowGallery, parent: ZoomAnimatedTransitioningDelegate) {
